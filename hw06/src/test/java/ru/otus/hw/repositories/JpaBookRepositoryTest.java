...
public class JpaBookRepositoryTest {
    ...
    void shouldFindExpectedBookById() {
        var optionalActualBook = jpaBookRepository.findById(BOOK_ID);
    ...
    void shouldFindAllBooks() {
        var actualBooksList = jpaBookRepository.findAll();
    ...
    void shouldDeleteBookById() {
        jpaBookRepository.deleteById(BOOK_ID_TO_DELETE);
    ...
    void shouldSaveNewBook() {
        ...
        Book book = Book.builder().id(0).title("NewTestBook").author(author).genre(genre).build();
    ...
    void shouldUpdateBookById() {
        ...
        Book savedBook = jpaBookRepository.save(updatedBook);
