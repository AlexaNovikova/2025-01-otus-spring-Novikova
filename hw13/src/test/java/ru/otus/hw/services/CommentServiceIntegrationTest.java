...
public class CommentServiceIntegrationTest {
    ...
    @DisplayName(" должен выбрасывать исключение AccessDeniedException при попытке удаления комментария по id" +
            " пользователем, у которого на это нет прав")
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
    @WithMockUser(value = "user", roles = "ADULT")
    @Test
    void shouldThrowAccessDeniedExceptionWhenDeleteCommentByIdWithoutPermission() {
