...
public class InternalInventoryController implements InventoryServiceClient {
    ...
    public ProductsBalanceResponseDto getActualBalance(@RequestParam List<Long> productIds) {
    ...
    @Override
    @GetMapping
    public ProductAvailableQuantityResponseDto getActualQuantity(@RequestParam Long productId) {
        log.debug("Trying to check actual quantity for product with id: {}",
                productId);
