...
import ru.otus.lib.kafka.model.ProcessStatus;
...
public class OrderProcessorService {
    ...
    public Order createOrder(Order order) {
        ...
        var reservationModel = ReservationProcessModel.startReservation(orderId, productMap);
    ...
    @Transactional
    public void handleReservationConfirmation(ReservationResultModel model) {
    ...
    @Transactional
    public void handlePaymentConfirmation(PaymentResultModel model) {
        var orderId = model.getOrderId();
        var orderOpt = orderRepository.findByIdForUpdate(orderId);
        if (orderOpt.isEmpty()) {
