...
public class BookServiceImpl implements BookService {
    ...
    public BookDto save(BookToSaveDto bookToSaveDto) {
        ...
        var bookDto = bookToDtoConverter.convert(bookSaved);
        if (bookToSaveDto.getId() == null) {
            aclServiceWrapperService
                    .createPermissions(BasePermission.READ, !bookSaved.isAdultOnly(),
                            bookSaved, bookDto, bookToDtoConverter.convertToBookDtoWithComments(bookSaved));
        }
        return bookDto;
    }
}
