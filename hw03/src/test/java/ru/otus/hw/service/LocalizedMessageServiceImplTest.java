...
public class LocalizedMessageServiceImplTest {
    ...
    @Test
    @DisplayName("Проверка, что сообщение выводится на английском при установленной английской локали")
    ...
    @Test
    @DisplayName("Проверка, что сообщение выводится на русском языке при установленной русской локали")
